...
interface TabMenuWithOverflowProps extends Omit<DropMenuComponentProps, 'onSelectItem' | 'targetElement'>, DropMenuStyleProps {
    /** Размер компонента */
    dimension?: TabDimension;
...
export interface TabMenuHorizontalWithOverflowMenuProps extends TabMenuBaseProps, TabMenuWithOverflowProps, TabMenuWithAddTabButtonProps {
    /** Внешний вид активной вкладки */
    appearance?: TabAppearance;
    showActiveTabSelector?: boolean;
}
export interface TabMenuHorizontalProps extends TabMenuBaseProps, TabMenuWithOverflowProps, TabMenuWithAddTabButtonProps {
    /** Внешний вид активной вкладки */
    appearance?: TabAppearance;
    adaptive?: TabAdaptive;
}
