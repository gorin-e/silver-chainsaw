...
import type { Color } from '../../components/themes';
import type { HeaderCell } from '../../components/Table/style';
...
export type Column = {
    ...
    headerPropsConfig?: (props: React.ComponentProps<typeof HeaderCell> & DataAttributes) => Partial<React.ComponentProps<typeof HeaderCell> & DataAttributes>;
};
/**
...
export interface TableProps extends React.HTMLAttributes<HTMLDivElement> {
    ...
    rowBackgroundColorByStatusMap?: {
        [key: string]: ((color: Color) => string) | string;
    };
}
