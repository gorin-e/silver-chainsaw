...
export declare const DefaultFontColorName: ColorName;
export declare const DefaultBackgroundColorName: ColorName;
export declare const MainPrimaryColorName: ColorName;
...
export type BorderRadiusType = 'Border radius 0' | 'Border radius 2' | 'Border radius 4' | 'Border radius 6' | 'Border radius 8' | 'Border radius 10';
