import{jsx}from"react/jsx-runtime";import styled,{keyframes,css}from"styled-components";const AnimationS=keyframes`
 0% {
    width: 6px;
    height: 6px;
    opacity: 100%;
...
`,PulseElement=styled.div`
  ...
  ${p=>p.$cssMixin}
`,Pulse=({dimension="m",status="info",cssMixin,...props})=>jsx(PulseElement,{$dimension:dimension,$status:status,$cssMixin:cssMixin,...props});export{Pulse};
