...
export type TransformAction = 'flipY' | 'flipX' | 'rotateLeft' | 'rotateRight' | 'zoomChange' | 'move' | 'touchZoom' | 'reset';
...
export interface ImagePreviewProps extends Omit<ImageViewerToolbarProps, 'transform' | 'actions' | 'actionsDisabled' | 'minScale' | 'maxScale'> {
    /** Элемент для просмотра */
    item: string | ImageProps;
...
export interface ImageViewerProps extends Pick<ImageMiniatureProps, 'dimension'>, Omit<ImagePreviewProps, 'item' | 'totalImg' | 'activeImg'> {
