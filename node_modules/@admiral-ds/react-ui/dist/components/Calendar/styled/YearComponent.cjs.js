"use strict";var styled=require("styled-components"),typography=require("../../Typography/typography.cjs.js");function _interopDefault(e){return e&&e.__esModule?e:{default:e}}require("../../Typography/defaultTypographyMixin.cjs.js");const YearComponent=_interopDefault(styled).default.div`
  position: relative;
  ...
  margin-bottom: ${"16px"};
  border: 1px solid
    ${({$today,theme})=>$today?`var(--admiral-color-Neutral_Neutral90, ${theme.color["Neutral/Neutral 90"]})`:"transparent"};
  border-radius: ${"18px"};
...
//# sourceMappingURL=YearComponent.cjs.js.map
